export const bank_account_screen = {
    ...
    delete_bank_account_button: '[data-test="bankaccount-delete"]',
    deleted_bank_account: '[class="MuiTypography-root MuiTypography-body1 MuiTypography-colorPrimary MuiTypography-gutterBottom"]'
}